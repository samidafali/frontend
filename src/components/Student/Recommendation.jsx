...
const Recommendation = () => {
    ...
    useEffect(() => {
        const fetchCategories = async () => {
            try {
                const response = await axios.get(`${process.env.REACT_APP_RECOMMENDATION_BASE_URL}/categories`);
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const response = await axios.post(`${process.env.REACT_APP_RECOMMENDATION_BASE_URL}/recommend`, {
                category,
                difficulty,
            });
